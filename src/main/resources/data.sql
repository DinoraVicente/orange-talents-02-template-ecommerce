INSERT INTO Usuario(email, senha) VALUES('fulano@email.com', '$2a$10$WY2ZL3oL4aRxl0l9xtk9B.vS8NAx2qcRfeG9Tl96g/Vw3EeyTFth.');
INSERT INTO Usuario(email, senha) VALUES('moderator@email.com', '$2a$10$WY2ZL3oL4aRxl0l9xtk9B.vS8NAx2qcRfeG9Tl96g/Vw3EeyTFth.');

INSERT INTO PROFILE(id, name) VALUES(1, 'ROLE_USER');
INSERT INTO PROFILE(id, name) VALUES(2, 'ROLE_MODERATOR');

INSERT INTO Usuario_PROFILES(Usuario_id, profiles_id) VALUES  (1, 1);
INSERT INTO Usuario_PROFILES(Usuario_id, profiles_id) VALUES  (2, 2);

INSERT INTO CATEGORY(nome) VALUES ('Category 1');
INSERT INTO CATEGORY(nome) VALUES ('Category 2');
